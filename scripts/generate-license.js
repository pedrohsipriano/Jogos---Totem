...
function main() {
  ...
  const now       = new Date();
  const expireAt  = new Date(now.getTime() + args.days * 24 * 60 * 60 * 1000);
  ...
  console.log(`   Expira em   : ${expireAt.toLocaleString('pt-BR')} (${args.days} dias)`);
